...
var sys = FlowRouter.group({
  ...
  triggersEnter: [
    function(context, redirect) {
      ...
      console.log("Admin area access check for:", context.path, "User:", currentUserId);
      ...
      if (!Roles || !Roles.userIsInRole || !Roles.userIsInRole(currentUserId, ["admin", "moderator"], "CB")) {
